...
public class CountryEvent {
	...
	/*
	 * A CountryEvent is a news per country (US,CA,DE,ES,etc) with relative fields (datum)
	 * It can be mapped to a CurrencyEvent using an accurate mapping to the right currency 
	 * (ex. DE/IT/FR news to EUR, US to USD) and the same event's date.
	 * 
	 * NB: if the field's id/datum's id is negative it means the market's entrance as 
	 * to be made in short position
	 */
	public CountryEvent() {
		/*
		category = 10;

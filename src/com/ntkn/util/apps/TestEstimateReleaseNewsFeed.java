	...
	public TestEstimateReleaseNewsFeed() {
        ...
        try {
              ...
              while(content.hasNext()) {
                  ...
                  byte[] headerBytes = Base64.getDecoder().decode((String)news.get("HeaderBytes"));
                  byte[] payloadBytes = Base64.getDecoder().decode((String)news.get("PayloadBytes"));
                  byte[] crcBytes = Base64.getDecoder().decode((String)news.get("CrcBytes"));

...
import com.nktin.flavix.EventResult;
	...
	public static void main(String[] args) 
	{
       ...
       String DATE_FORMAT = "HH:mm:ss.SSS";
		...
		try
		{
		    ...
		    newsEvent.addField(4, 9.8d, false);
		    newsEvent.addField(3, 1.1d, true);
		    countryEvent.addNews(newsEvent);
		    newsEvent = new NewsEvent(101);
		    newsEvent.addField(1, 27.7d, true);
		    newsEvent.addField(2, 55.0d, false);
		    countryEvent.addNews(newsEvent);
